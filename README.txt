Matlab scripts with supporting functions and input data used to carry out computations, analyse results and create figures in connection with the article "Data Assimilation for a Geological Process Model Using the Ensemble Kalman Filter" by J. Skauvold and J. Eidsvik. Accepted for publication in Basin Research, December 2017.
